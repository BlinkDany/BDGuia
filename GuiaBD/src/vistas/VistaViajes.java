...
public class VistaViajes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fSTexFieldMD1.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        fSTexFieldMD1.setPlaceholder("Id del conductor");

        fSTexFieldMD2.setForeground(new java.awt.Color(0, 0, 0));
        fSTexFieldMD2.setBordeColorFocus(new java.awt.Color(0, 0, 0));
        fSTexFieldMD2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        fSTexFieldMD2.setPlaceholder("Matricula");
